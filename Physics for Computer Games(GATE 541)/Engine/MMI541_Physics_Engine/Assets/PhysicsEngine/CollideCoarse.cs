...
namespace cyclone
{
    ...
    */
     ...
     * volumes.
     */
    class BVHNode<BoundingVolumeClass> where BoundingVolumeClass : BoundingSphere, new()
    {
        ...
        protected void recalculateBoundingVolume(bool recurse = true)
        {
            ...
            //TODO this needs to be 'fixed' to the commented version which currently gives error
