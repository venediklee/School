...
private:
    ...
    bool softFork; //(default)false-> hard forked or non-forked // true-> soft forked;
...
public:
    ...
    bool getForkType() const;
    void changeForkType(std::string softness);
    void setHead(Koin *newHead);
